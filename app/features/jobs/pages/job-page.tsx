      ...
      <div className="grid grid-cols-6 items-start">
        <div className="col-span-4 -mt-16">
          <img
            ...
            className="relative left-8 size-32 rounded-full"
          />
          ...
          <div className="mt-8 flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              ...
              <p>
                We are looking for a Software Engineer with a passion for
                building scalable and efficient systems. You will be responsible
                for designing and implementing new features and improving
                existing ones.
              </p>
            </div>
            <div className="flex flex-col gap-2">
