...
export default function PromotePage() {
 ...
 const totalDays =
  date?.from && date?.to
   ? DateTime.fromJSDate(date.to).diff(DateTime.fromJSDate(date.from), 'days').days
   : 0;
   ...
   <Form className="mx-auto flex max-w-sm flex-col items-center gap-4">
    ...
    <div className="flex flex-col items-center gap-2">
     <div className="flex flex-col items-center">
      <Label className="flex flex-col font-semibold">Select a range of dates for promotion</Label>
