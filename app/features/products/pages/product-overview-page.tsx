  ...
  <>
   <div>
    ...
    <TypographyMuted className="text-base">
     This product is a comprehensive solution designed to meet the needs of users looking for
     efficiency and reliability. It offers a range of features that enhance productivity and
   ...
   <div>
    ...
    <TypographyMuted className="text-base">
     - Feature 1: Description of feature 1. - Feature 2: Description of feature 2. - Feature 3:
