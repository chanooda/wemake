import { ChartColumnIcon, LogOutIcon, SettingsIcon, UserIcon } from 'lucide-react';
...
export const LINK = {
 ...
 PRODUCT_LEADERBOARDS_REDIRECT: (period: 'weekly' | 'daily' | 'monthly' | 'yearly') =>
 ...
 AUTH_SOCIAL_COMPLETE: (provider: string) => `/auth/social/${provider}/complete`,
};
