...
ALTER TABLE "teams" ADD CONSTRAINT "teams_team_leader_profiles_profile_id_fk" FOREIGN KEY ("team_leader") REFERENCES "public"."profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
