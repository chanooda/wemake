...
export const loader = async () => {
  ...
  const [products, jobs, ideas, discussions, teams] = await Promise.all([productsPromise, jobsPromise, ideasPromise, discussionsPromise, teamsPromise])
...
export default function Home({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="flex flex-col gap-24">
      <div className="3xl:grid-cols-5 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 auto-rows-fr">
