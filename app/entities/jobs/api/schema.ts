...
import {
 JOBS_FILTER_LOCATION_ENUM,
 JOBS_FILTER_SALARY_RANGE_ENUM,
 JOBS_FILTER_TIME_ENUM,
} from '../config/jobs.const';

export const job_type = pgEnum('job_type', JOBS_FILTER_TIME_ENUM as [string, ...string[]]);

export const locations = pgEnum('locations', JOBS_FILTER_LOCATION_ENUM as [string, ...string[]]);
